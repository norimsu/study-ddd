...
public class PokemonApiClient implements PokemonRepository {
  ...
  public PokemonApiClient(PokemonTranslator pokemonTranslator) {
    this.pokemonTranslator = pokemonTranslator;
  }

  @Override
  public Optional<Pokemon> findById(NationalPokedexNumber id) {
    final PokemonSpecies pokemonSpecies = POKE_API_CLIENT.getPokemonSpecies(id.toInt());
